...
//邀请链接
$System_Config['enable_invite_code']='false';      //是否强制开启邀请，为true则注册必须使用邀请链接 且 邀请人等级为0时邀请链接不可用
$System_Config['inviteNum'] = '10';      // 注册后的邀请链接可用次数
$System_Config['invite_get_money']='1';      //新用户通过私人邀请链接注册，获得奖励金额（鼓励消费）
...
//已注册用户设置------------------------------------------------------------------
$System_Config['checkinMin'] = '1';       //用户签到签到最少流量 单位MB
$System_Config['checkinMax'] = '50';       //用户签到签到最多流量
